	...
	<body>
        ...
        <div id="left" style="float:left; width:auto;">
            <div style="float:left; margin:auto;">
                <?php                     
                    ...
                    if(isset($_GET['inasede'])){
                        $codsede = $_GET['inasede'];
                        $c->conexion();
                        $c->anularsede($codsede);
                        echo "<br/><div class='exito'><b>Se Anulo la Sede Correctamente</b></div>" ;
                        $c->desconexion();
                    }
                ?>  
        ...
        <div id="right" style="float:right; width:auto; margin-right:40px;">
            <div id="opcsede" style="width:auto; float:right;">
                ...
                <a href="sede.php" style="text-decoration:none;"><input name="" class="boton" type="button" value="Activas"></a>
            </div>
        </div> 
