        		...
        		<div class="efecto2" id="message" style="width:auto;">
                    ...
                    <div id="conf" style="float:left; height:80px;">
                        <div class="subTitle">
                            ...
                            <h3 style="color:green;">Asignar Educadora</h3>
                        </div>                        
                    </div>
        		</div>
        </div>                     
            ...
            <div id="cbos" style="margin:auto;">
                <?php 
                    ...
                    if(isset($_POST['asigLevel'])){
                        ...
                        $c->conexion();
                        $c->AsigNivelSede($codedu, $codlevel);
                        $c->desconexion();
                    }
                ?>

                <form class="contact_form" action="asigEdu.php" method="post" name="level_form">
                    <ul>
                        <li>
                            <h2>Asignar Educadora a Nivel</h2>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <button name="asigLevel" class="boton" type="submit" style="width:auto; margin-top:20px;">Asignar</button>
                        </li>
                    </ul>
                </form>
            </div>           
