        		...
        		<div class="efecto2" id="message" style="width:auto;">
                    ...
                    <div id="conf" style="float:left; height:80px;">
                        <div class="subTitle">
                            ...
                            <h3 style="color:green;">Gestion Nivel</h3>
                        </div>                        
                    </div>
        		</div>
        </div>                     
            ...
            <div id="tableSede" style="float:left; margin:auto;">
                <?php 
                    ...
                    if (isset($_POST['actualizar'])) {
                        ...
                        echo "<br/><div class='exito' style='width:250px;'><b>Se Actualizo Correctamente El Registro</b></div>" ;
                        $c->desconexion();
                    }

                    if(isset($_GET['actlevel'])){
                        $codlevel = $_GET['actlevel'];
                        $c->conexion();
                        $c->activarNivel($codlevel);
                        echo "<br/><div class='exito' style='width:200px;'><b>Se Activo El Nivel Correctamente</b></div>" ;
                        $c->desconexion();
                    }
