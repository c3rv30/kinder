        ...
        <div class="top">
        		<div class="efecto2" id="message" style="width:900px;">
                    ...
                    <div id="conf" style="float:left; height:80px;">
                        <h2>Configuracion</h2>
                        <h3>Menu Mantencion Sistema</h3>
                    </div>
        		</div>
        </div>                     
    	<section id="content" style="height:300px; margin-bottom:225px;"> 
            <div class="link-heading">
                <form class="contact_form" action="level.php" method="post" name="level_form">
                    <ul>
                        <li>
                            <h2>Ingresar Nivel</h2>
                            <span class="required_notification">* Denotes Required Field</span>
                        </li>
                        <li>
                            <label for="name">Nombre Nivel:</label>
                            <input type="text" name="txtnomnivel"  placeholder="SalaCuna" required />
                        </li>            
                            <button name="reglevel" class="boton" type="submit" style="width:auto; margin-top:20px;">Ingresar</button>
                        </li>
                    </ul>
                </form>
            </div>
