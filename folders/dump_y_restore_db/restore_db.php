...
<BODY 
	...
	vlink="#000020" 
	alink="#000020">
	<center><h1>Restauracion de la Base de Datos</h1></center><br>
...
<BODY 
	...
	alink="#000020">
	<br><br>
	<center><h1>Restauracion de la Base de Datos</h1></center><br><br>
	<center><a href="respaldar.php"><INPUT style="width:200px;" class="boton" type=button value="Volver a Kinder"></INPUT></a></center><br><br>
	<strong>
<?php
	error_reporting(0);
	@set_time_limit( 0 );
	...
	if (!$error) { 
	    $result = "SHOW TABLES FROM $db_name";
			if (!$result) {
