    	...
    	<section id="content" style="height:400px;">    	                           
                <div id="left" style="float:left; width:auto; margin-left:40px;margin-top:40px;">
                    <div id="opcsede" style="width:auto; float:right;">
                        <a href="backup.generic.php" style="text-decoration:none;"><input style="width:250px;" class="boton" type="button" value="Generar Respaldo BD"></a>
                        <a href="seleccionar_respaldo2.php" style="text-decoration:none;"><input style="width:150px; margin-left:25px;" name="" class="boton" type="button" value="Restaurar BD"></a></br></br>
                        <a href="conf_auto.php" style="text-decoration:none;"><input style="width:250px;" name="" class="boton" type="button" value="Configurar Respaldo Auto."></a>
                    </div>
                </div>                                                    
    	</section>               
    	<footer>
